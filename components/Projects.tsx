...
function ProjectCard({ repo, index }: { repo: GitHubRepo; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className={`reveal ${inView ? 'visible' : ''} group bg-surface border border-border rounded-2xl p-6 flex flex-col gap-4 hover:border-accent/30 transition-all duration-300`}
